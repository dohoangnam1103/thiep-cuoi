...
export const templates = [
  {
    ...
    "title": "Double Happiness Red Template - Elegant Shuangxi & Arch Photo | ChungDoi",
    "description": "Double Happiness Red wedding e-card: red sunburst, shuangxi motif, arch photo frame, happiness seal envelope. Free to create, 3-day trial on ChungDoi.",
  ...
  },
  {
    ...
    "title": "Double Happiness Green Template - Forest Green Shuangxi & Arch Photo | ChungDoi",
    "description": "Double Happiness Green wedding e-card: forest green shuangxi motif, arch photo frame, happiness seal envelope. Free to create, 3-day trial on ChungDoi.",
    "category": "Traditional",
    "color": "Green",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Double Dragon Red Template - Traditional Elegant Wedding Invitation | ChungDoi",
    "description": "Double Dragon Red online wedding invitation featuring classic twin dragon motifs and elegant red tones. Free to create, 3-day trial on ChungDoi.",
    "category": "Traditional",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Double Phoenix Red Template - Graceful Traditional Wedding Invitation | ChungDoi",
    "description": "Double Phoenix Red online wedding invitation featuring elegant twin phoenix motifs and a classic red palette. Free to create on ChungDoi.",
    "category": "Traditional",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Elegant Leaf Green Template - Modern Minimalist Wedding Invitation | ChungDoi",
    "description": "Elegant Leaf Green online wedding invitation — clean green tones with a refined minimalist style. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Dragon Phoenix Red Template - Classic Traditional Wedding Invitation | ChungDoi",
    "description": "Dragon Phoenix Red online wedding invitation with classic dragon and phoenix motifs, formal red tones. Free to create on ChungDoi.",
    "category": "Traditional",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Dragon Phoenix V3 Red Template - Deep Red Classic Wedding Invitation | ChungDoi",
    "description": "Dragon Phoenix V3 Red online wedding invitation featuring an arched dragon-phoenix photo frame, deep red tones, and swallow accents. Free on ChungDoi.",
    "category": "Traditional",
    "color": "Red",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Dragon Phoenix V2 Red Template - Classic Modern Wedding Invitation | ChungDoi",
    "description": "Dragon Phoenix V2 Red online wedding invitation — improved version with refined dragon and phoenix artwork and a modern layout. Free to create on ChungDoi.",
    "category": "Traditional",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Double Dragon Green Template - Elegant Nature-Inspired Wedding Invitation | ChungDoi",
    "description": "Double Dragon Green online wedding invitation with classic twin dragon motifs and fresh green tones. Free to create, 3-day trial on ChungDoi.",
    "category": "Traditional",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Boho Floral Green Template - Fresh Watercolor Wedding Invitation | ChungDoi",
    "description": "Boho Floral Green wedding invitation with fresh green watercolor flowers on a warm cream background. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Boho Floral Pink Template - Romantic Watercolor Wedding Invitation | ChungDoi",
    "description": "Boho Floral Pink wedding invitation with romantic pink watercolor flowers on a warm cream background. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Pink",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "jasmine-white",
    "name": "Jasmine White",
    "title": "Jasmine White Template - Minimalist Elegant Wedding Invitation | ChungDoi",
    "description": "Jasmine White wedding invitation with a warm cream background and deep olive green tones — a refined, minimalist modern style. Free demo on ChungDoi.",
    "category": "Signature",
    "color": "White",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Silk Flora Brown Template - Minimal Warm Cream Wedding Invitation | ChungDoi",
    "description": "Silk Flora Brown is a warm minimalist wedding invitation with clean typography, clear structure, and a calm modern tone. Free demo on ChungDoi.",
    "category": "Signature",
    "color": "Brown",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "chateau-blue",
    "name": "Chateau Blue",
    "title": "Chateau Blue Template - Classic European Royal Wedding Invitation | ChungDoi",
    "description": "Chateau Blue wedding e-card: hand-painted European manor, banquet table, Italian cypress trees, framed mini calendar; deep blue on cream. Free to create, 3-day trial on ChungDoi.",
    "category": "Royal",
    "color": "Blue",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Brocade Flower Red Template - Ornate Red and Gold Wedding Invitation | ChungDoi",
    "description": "Brocade Flower Red wedding e-card: ornate brocade patterns, red roses, gold pillars and a floral calendar frame; deep maroon and olive green on warm cream. Free to create, 3-day trial on ChungDoi.",
    "category": "Royal",
    "color": "Red",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Crystal Floral Blue Template - Elegant European Blue Wedding Invitation | ChungDoi",
    "description": "Crystal Floral Blue wedding e-card: a porcelain-blue crystal floral frame, delicate florals, warm cream background and a dedicated calendar frame; fresh porcelain blue. Free to create, 3-day trial on ChungDoi.",
    "category": "Floral",
    "color": "Blue",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    "slug": "chateau-green",
    "name": "Chateau Green",
    "title": "Chateau Green Template - European Garden Wedding Invitation | ChungDoi",
    "description": "Chateau Green wedding e-card: watercolor European chateau on a wildflower garden, leafy trees, fountain, forest-green palette on cream. Free to create, 3-day trial on ChungDoi.",
    "category": "Royal",
    "color": "Green",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    "slug": "baroque-gold",
    "name": "Baroque Gold",
    "title": "Baroque Gold Template - Ornate Gold Frame European Wedding Invitation | ChungDoi",
    "description": "Baroque Gold wedding e-card: ornate gilded frame, Roman pillars, damask ivory background and a gold framed calendar; gold-bronze with olive. Free to create, 3-day trial on ChungDoi.",
    "category": "Royal",
    "color": "Gold",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    "slug": "qasr-green",
    "name": "Qasr Green",
    "title": "Qasr Green Template - Domed Palace Garden Wedding Invitation | ChungDoi",
    "description": "Qasr Green wedding e-card: a domed palace and a couple in sage-green attire on warm cream, white-rose and eucalyptus florals, a heart-marked framed calendar, and full Arabic RTL support. Free to create on ChungDoi.",
    "category": "Royal",
    "color": "Green",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    "slug": "qasr-gold",
    "name": "Qasr Gold",
    "title": "Qasr Gold Template - Desert Oasis Domed Palace Wedding Invitation | ChungDoi",
    "description": "Qasr Gold wedding e-card: a domed palace amid a desert oasis, date palms, a couple in Gulf attire on warm sand-cream, a heart-marked framed calendar, and full Arabic RTL support. Free to create on ChungDoi.",
    "category": "Royal",
    "color": "Gold",
    "isNew": true,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Glass Garden Green Template - Soft Floral Garden Wedding Invitation | ChungDoi",
    "description": "Glass Garden Green wedding e-card: a soft floral background fills the card, the names sit in a clear oval glass frame, and a large glass panel wraps the content in garden-green over white blooms. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "royal-red",
    "name": "Royal Red",
    "title": "Royal Red Template - Luxurious Royal Wedding Invitation | ChungDoi",
    "description": "Royal Red wedding invitation with deep red background and stunning gold accents. A regal, high-end style. Free to create on ChungDoi.",
    "category": "Royal",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "nhat-binh-red",
    "name": "Nhat Binh Red",
    "title": "Nhat Binh Red Template - Cream Paper, Vermillion Accents, Brown Envelope | ChungDoi",
    "description": "Nhat Binh Red wedding invitation: warm cream paper, brown and vermillion type, parallax clouds and florals; brown envelope, cream card, double-happiness seal. Free on ChungDoi.",
    "category": "Traditional",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Love Art Red Wedding Invitation Template - Romantic Comic-Art Style | ChungDoi",
    "description": "Love Art Red online wedding invitation: comic-art style, red heart florals, handwritten fonts, unique tilted couple photo frames. Free to create on ChungDoi.",
    "category": "Modern",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "co-ba-red",
    "name": "Co Ba Red",
    "title": "Co Ba Red Template - Vietnamese Vintage Wedding Invitation | ChungDoi",
    "description": "Co Ba Red wedding e-card: warm aged-paper background, brown type with a blue accent, Ben Thanh Market illustration, and a matching brown envelope. Free to create, 3-day trial on ChungDoi.",
    "category": "Modern",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "royal-blue",
    "name": "Royal Blue",
    "title": "Royal Blue Template - Luxurious Royal Wedding Invitation | ChungDoi",
    "description": "Royal Blue wedding invitation with deep navy background and stunning gold accents. A regal, high-end style. Free to create on ChungDoi.",
    "category": "Royal",
    "color": "Blue",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "royal-green",
    "name": "Royal Green",
    "title": "Royal Green Template - Luxurious Royal Wedding Invitation | ChungDoi",
    "description": "Royal Green wedding invitation with deep forest green background and stunning gold accents. A regal, high-end style. Free to create on ChungDoi.",
    "category": "Royal",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Spring Garden Green Template - Fresh Nature Wedding Invitation | ChungDoi",
    "description": "Spring Garden Green online wedding invitation with hand-drawn leaf motifs and refreshing green tones. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "chibi-red",
    "name": "Chibi Red",
    "title": "Chibi Red Template - Cute Illustrated Wedding Invitation | ChungDoi",
    "description": "Chibi Red online wedding invitation featuring adorable illustrated couple artwork and a playful design. Free to create on ChungDoi.",
    "category": "Modern",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Boho Floral Brown Template - Rustic Earthy Wedding Invitation | ChungDoi",
    "description": "Boho Floral Brown wedding invitation with rustic brown watercolor flowers on a warm cream background. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Brown",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Spring Garden Red Template - Warm Nature Wedding Invitation | ChungDoi",
    "description": "Spring Garden Red online wedding invitation with floral nature motifs and warm red tones. Free to create, 3-day trial on ChungDoi.",
    "category": "Floral",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Dragon Phoenix Green Template - Classic Refined Wedding Invitation | ChungDoi",
    "description": "Dragon Phoenix Green online wedding invitation with dragon and phoenix motifs and elegant green tones. Free to create on ChungDoi.",
    "category": "Traditional",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Spring Garden Blue Template - Refined Elegant Wedding Invitation | ChungDoi",
    "description": "Spring Garden Blue online wedding invitation with floral nature motifs and soft blue tones. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Blue",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    "slug": "minimalism-red",
    "name": "Minimalism Red",
    "title": "Minimalism Red Template - Modern Minimalist Wedding Invitation | ChungDoi",
    "description": "Minimalist style wedding invitation with a clean white background and elegant red accents. Refined, contemporary, and free to create on ChungDoi.",
    "category": "Modern",
    "color": "Red",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Cherry Blossom Pink Template - Romantic Floral Wedding Invitation | ChungDoi",
    "description": "Cherry Blossom Pink online wedding invitation with soft pink sakura petals and a romantic modern style. Free to create on ChungDoi.",
    "category": "Floral",
    "color": "Pink",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Double Phoenix Green Template - Graceful Nature Wedding Invitation | ChungDoi",
    "description": "Double Phoenix Green online wedding invitation with twin phoenix motifs and fresh green tones. Free to create on ChungDoi.",
    "category": "Traditional",
    "color": "Green",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Double Dragon Blue Template - Romantic Gentle Wedding Invitation | ChungDoi",
    "description": "Double Dragon Blue online wedding invitation with twin dragon motifs and soft blue tones. Free to create, 3-day trial on ChungDoi.",
    "category": "Traditional",
    "color": "Blue",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Dragon Phoenix Blue Template - Classic Luxurious Wedding Invitation | ChungDoi",
    "description": "Dragon Phoenix Blue online wedding invitation with classic dragon and phoenix motifs and elegant blue tones. Free to create on ChungDoi.",
    "category": "Traditional",
    "color": "Blue",
    "isNew": false,
    "highlights": [
  ...
  },
  {
    ...
    "title": "Dragon Phoenix Black Template - Mysterious Luxurious Wedding Invitation | ChungDoi",
    "description": "Dragon Phoenix Black online wedding invitation with dragon and phoenix motifs on a deep black background. Free to create on ChungDoi.",
    "category": "Traditional",
    "color": "Black",
    "isNew": false,
    "highlights": [
...
const vietnameseSlugBySourceSlug = new Map<string, string>(vietnameseTemplateSlugs.map(([sourceSlug, routeSlug]) => [sourceSlug, routeSlug]));
const sourceSlugByRouteSlug = new Map<string, string>([
  ...templates.map((template) => [template.slug, template.slug] as const),
...
export function findTemplateByRouteSlug(routeSlug: string) {
  const sourceSlug = sourceSlugByRouteSlug.get(routeSlug);
