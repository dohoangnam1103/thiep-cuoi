        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-14 px-4 pb-14 md:px-10">
          ...
          <section className="flex w-full flex-col items-center gap-8">
            ...
            <div className="flex w-full flex-col items-center gap-2 text-center">
              ...
              <h3 className="font-couple-playfair flex min-h-[80px] w-[80%] items-center justify-center text-[30px] leading-[1.15] md:text-[40px]" style={{ color: BFR_RED }}>{people[0].fullName}</h3>
              ...
              <h3 className="font-couple-playfair flex min-h-[80px] w-[80%] items-center justify-center text-[30px] leading-[1.15] md:text-[40px]" style={{ color: BFR_RED }}>{people[1].fullName}</h3>
