      ...
      <div className="relative flex w-full max-w-[480px] flex-col overflow-hidden mx-auto md:max-w-[900px] md:border md:border-[#88292522]" style={{ backgroundColor: DD_LINEN }}>
        ...
        <div className="relative w-full overflow-hidden px-2 py-6 sm:py-8 md:py-10" style={{ backgroundColor: DD_LINEN }}>
          ...
          <div className="pointer-events-none relative z-20 flex items-start justify-center gap-2 sm:gap-4">
            <div className="pointer-events-auto flex min-w-0 flex-1 flex-col items-center">
              ...
              <div data-invitation-short-name className="whitespace-nowrap text-2xl sm:text-3xl md:text-4xl" style={{ color: DD_RED, fontFamily: '"Fz Aghita", cursive' }}>{avatarCards[0].person.shortName}</div>
            </div>
            ...
            <div className="pointer-events-auto flex min-w-0 flex-1 flex-col items-center">
              ...
              <div data-invitation-short-name className="whitespace-nowrap text-2xl sm:text-3xl md:text-4xl" style={{ color: DD_RED, fontFamily: '"Fz Aghita", cursive' }}>{avatarCards[1].person.shortName}</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-full overflow-hidden" style={{ backgroundColor: DD_LINEN }}>
          ...
          <div className="relative z-10">
            ...
            <div className="mt-6 grid w-full grid-cols-[1fr_auto_1fr] grid-rows-[auto_auto_auto_auto] items-start gap-x-2 gap-y-1 px-2 sm:px-4 md:gap-x-8" style={{ color: DD_RED, fontFamily: DD_SERIF }}>
              {familyColumns.map((f, i) => (
                <div key={i} className="contents">
                  {i === 1 ? <div className="row-span-4 w-px self-stretch justify-self-center" style={{ backgroundColor: DD_RED }} /> : null}
                  ...
                  <div className="row-span-4 grid w-full min-w-0 grid-rows-subgrid items-start justify-items-center text-center md:max-w-[280px] md:justify-self-center">
                    <span className="text-[12px] md:text-[15px]" style={{ color: DD_GRAY }}>{f.title}</span>
                    <span className="text-[13px] font-semibold md:text-[15px]" style={{ color: DD_RED }}>{f.a}</span>
                    <span className="text-[13px] font-semibold md:text-[15px]" style={{ color: DD_RED }}>{f.b}</span>
                    {/* w-full: trong ô subgrid, div không khai bề rộng sẽ co theo
                        max-content nên địa chỉ dài tràn ra ngoài cột. */}
                    <div className="mt-1 flex w-full max-w-full flex-col whitespace-pre-line text-[11px] leading-tight md:text-[13px]" style={{ color: DD_GRAY }}>{f.addr}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="relative mb-6 mt-4 flex flex-col items-center gap-3 text-center md:gap-4">
              ...
              <h3 className="font-couple-garamond flex w-full items-center justify-center leading-[1.2] md:leading-[64px]" style={{ fontSize: "clamp(24px, 6vw, 42px)", color: DD_RED, wordBreak: "keep-all" }}>{people[0].fullName}</h3>
              ...
              <h3 className="font-couple-garamond flex w-full items-center justify-center leading-[1.2] md:leading-[64px]" style={{ fontSize: "clamp(24px, 6vw, 42px)", color: DD_RED, wordBreak: "keep-all" }}>{people[1].fullName}</h3>
