...
void main() {
  ...
  float height = noise * 0.6;
  float intensity = smoothstep(height - uBlend * 0.5, height + uBlend * 0.5, uv.y);
  float alpha = 1.0 - intensity;

  vec3 color = rampColor(uv.x) * alpha;
...
export default function AuroraBackground({
  colorStops = ["#d64550", "#e0a870", "#d64550"],
  amplitude = 1.0,
  blend = 0.5,
  className,
}: AuroraProps) {
