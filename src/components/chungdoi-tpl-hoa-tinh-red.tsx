...
import { invitationCouple, invitationGiftAccounts, orderedCouple } from "@/lib/invitation-display";
import {
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-14 px-4 pb-14 pt-10 md:px-10">
          ...
          <section className="flex w-full flex-col items-center gap-8">
            ...
            <div className="flex w-full flex-col items-center gap-2 text-center">
              ...
              <h3 className="font-couple-patrick flex min-h-[70px] w-[80%] items-center justify-center text-[30px] leading-[1.15] md:text-[40px]">{people[0].fullName}</h3>
              ...
              <h3 className="font-couple-patrick flex min-h-[70px] w-[80%] items-center justify-center text-[30px] leading-[1.15] md:text-[40px]">{people[1].fullName}</h3>
