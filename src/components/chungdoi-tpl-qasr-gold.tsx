    ...
    <div className="flex w-full justify-center overflow-x-clip bg-white">
      <div className="relative w-full max-w-[480px] overflow-hidden md:mx-auto md:max-w-[900px] md:border" style={{ color: QASR_GOLD_DARK, borderColor: hexToRgba(QASR_GOLD, 0.2) }}>
        ...
        <header className="relative z-10 flex w-full flex-col items-center px-4 pt-[70px] sm:px-5 md:pt-[100px]">
          ...
          <h1 className="relative z-10 mt-4 flex flex-col items-center leading-none" style={{ color: QASR_GOLD_DARK }}>
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-14 px-4 pb-14 md:px-10">
          ...
          <DressCode headingColor={QASR_GOLD_DARK} subColor={QASR_GOLD_MUTED} colors={[{ color: QASR_GOLD }, { color: "#f5efdd", border: QASR_GOLD }, { color: QASR_GOLD_DARK }]} />
          ...
          {banks.length > 0 ? (
            <section className="w-full text-center">
              <h2 className="mb-6 text-[20px] font-bold uppercase md:text-[24px]" style={{ color: QASR_GOLD_DARK }}>Phong Bao Mừng Cưới</h2>
                ...
                {banks.map((q) => {
                  ...
                  return (
                    <div key={q.label} className="flex max-w-[200px] flex-1 flex-col items-center">
                      ...
                      <a href={qr} target="_blank" rel="noreferrer" className="mt-3 rounded-full border px-4 py-1.5 text-[11px] font-semibold uppercase" style={{ borderColor: QASR_GOLD, color: QASR_GOLD_DARK }}>Lưu QR</a>
                    </div>
                  );
                })}
              </div>
        ...
        {/* FOOTER */}
        <footer className="relative z-10 flex w-full flex-col items-center justify-center px-4 py-6 text-center" style={{ backgroundColor: QASR_GOLD_DARK }}>
          <span className="text-[12px] md:text-[15px] lg:text-[18px]" style={{ color: "#f5efdd" }}>Sự hiện diện của quý khách là niềm vinh hạnh của gia đình chúng tôi!</span>
        </footer>
