    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#18120f]/85 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <button className="hidden size-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-zinc-200 transition hover:border-[#fb3570]/60 hover:text-white sm:flex">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-20 pt-10 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:pb-24 lg:pt-16">
        <div className="reveal flex flex-col justify-center">
          ...
          <h1 className="max-w-3xl text-4xl font-black leading-[1.05] tracking-tight text-white sm:text-6xl">
            Create wedding invitations online, free in 10 minutes
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
            Online wedding invitations with handcrafted templates, guest names, RSVP, maps, gallery, music and a QR gift box.
          </p>
          <p className="mt-4 text-sm font-semibold text-[#ffb5ca]">Free to create - 3-day trial - Pay only if you love it</p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            >
              Create Now <ArrowRight className="size-4" />
            </a>
            <a
              href="#how-it-works"
            ...
            >
              Watch guide <Play className="size-4" />
            </a>
          </div>
        </div>
        ...
        <div className="reveal relative min-h-[610px] lg:min-h-[720px]">
          ...
          <div className="absolute bottom-16 left-0 right-8 rounded-[1.75rem] border border-white/10 bg-white/[0.06] p-5 shadow-2xl shadow-black/30 backdrop-blur">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm text-zinc-400">Live invite demo</p>
                <p className="mt-1 text-xl font-bold text-white">Alex & Jordan</p>
              </div>
              <div className="rounded-full bg-emerald-400/15 px-3 py-1 text-xs font-bold text-emerald-200">RSVP open</div>
            </div>
    ...
    <section className="overflow-hidden bg-[#18120f] py-16">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <div className="reveal">
          <h2 className="text-3xl font-black text-white sm:text-5xl">Most Popular Invitation Templates</h2>
          <p className="mt-4 text-zinc-300">Discover beautifully designed wedding invitation templates.</p>
        </div>
      </div>
          ...
          {[...featuredTemplates, ...featuredTemplates].map((template, index) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-5">
                {template.isNew ? <span className="rounded-full bg-[#fb3570] px-2.5 py-1 text-xs font-bold text-white">New</span> : null}
  ...
  return (
    <section className="bg-[#fb3570] py-10 text-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 text-center sm:px-6 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-8 lg:text-left">
        <h2 className="text-2xl font-black leading-tight sm:text-3xl lg:max-w-lg">
          Over 65,000 couples have created their online wedding invitations with ChungDoi
        </h2>
        {[
...
function HowItWorks() {
  const steps: Array<[string, string, LucideIcon]> = [
    ["Choose a Template", "Pick your favorite template", CalendarDays],
    ["Fill in Your Details", "Add photos, names, wedding date, and venue", ImageIcon],
    ["Send Your Invitation", "Share instantly via LINE, Messenger, or any app", Mail],
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="reveal text-center">
          <h2 className="text-3xl font-black text-white sm:text-5xl">
            Create your online wedding invitation in just 10 minutes
          </h2>
          <p className="mt-4 text-zinc-300">Keep the tradition - enjoy the convenience.</p>
        </div>
          ...
          {steps.map(([title, copy, Icon], index) => (
            <div key={title as string} className="reveal rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-xl shadow-black/20">
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm font-bold text-[#ffb5ca]">Step {index + 1}</p>
              </div>
  ...
  return (
    <section className="bg-[#2a211e] py-16">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-8">
        <div className="reveal">
          <h2 className="text-3xl font-black text-white sm:text-5xl">When you need us, we&apos;re here</h2>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-zinc-300">
            The ChungDoi team is online 24/7. Chat whenever you need help with edits, sharing, guests, or payments.
          </p>
          <a
            href="#templates"
        ...
        <div className="reveal grid gap-4 sm:grid-cols-2">
          {[
            ["Reply time", "Usually under 1 minute"],
            ["Help with edits", "Until it feels right"],
          ].map(([label, value]) => (
  ...
  return (
    <section id="guests" className="relative overflow-hidden bg-[#211815] py-20">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        <div className="reveal">
          <p className="text-sm font-black uppercase tracking-[0.22em] text-[#ff8cad]">Create guests & manage RSVP</p>
          <h2 className="mt-4 text-3xl font-black text-white sm:text-5xl">Know who&apos;s coming, plan with ease</h2>
          <p className="mt-6 text-lg leading-8 text-zinc-300">
            Invite each guest with a personal link, collect attendance, party size and notes, then review everything from one clean dashboard.
          </p>
          <ul className="mt-8 space-y-4 text-zinc-200">
            {[
              "Add one guest at a time, or bulk add when your list is ready",
              "A personal link per guest, with a greeting on the envelope",
              "Guests confirm attending or declined, plus party size and notes",
              "Share a link so family can add guests without login",
              "Manage it all with clear stats and visual charts",
            ].map((item) => (
        ...
        <div className="reveal grid gap-5 lg:grid-cols-2">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.05] p-5 shadow-2xl shadow-black/35">
            <p className="text-sm text-zinc-400">Personal guest link</p>
            <h3 className="mt-3 text-2xl font-black text-white">Alex & Jordan, will you join us?</h3>
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="rounded-2xl bg-emerald-400 px-4 py-3 text-sm font-black text-emerald-950">I&apos;ll attend</button>
              <button className="rounded-2xl bg-white/10 px-4 py-3 text-sm font-black text-white">Declined</button>
            </div>
            {["Plus-ones", "Need a shuttle?", "Meal notes", "Song request"].map((label) => (
          ...
          <div className="rounded-[2rem] border border-white/10 bg-[#fb3570] p-5 text-white shadow-2xl shadow-[#fb3570]/20">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-white/75">Guest manager</p>
            <h3 className="mt-4 text-2xl font-black">RSVPs gathered in one place</h3>
...
function LanguageAndFeatures() {
  const features: Array<[string, string, LucideIcon]> = [
    ["Mobile Optimized", "Perfectly responsive on any phone screen for easy guest browsing", Heart],
    ["Beautiful Templates", "From traditional to modern styles, find the perfect match", Sparkles],
    ["Google Maps Navigation", "Built-in maps so guests can navigate to your venue in one tap", MapPin],
    ["Wedding Photo Album", "Showcase your best photos with a built-in gallery viewer", ImageIcon],
    ["Guest Book", "Guests can leave their wishes directly on your invitation", MessageCircle],
    ["Gift Box", "Accept gifts via bank transfer QR code, simple and convenient", Gift],
  ];
  ...
  return (
    <>
      <section className="bg-[#18120f] py-20">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          <div className="reveal rounded-[2rem] border border-white/10 bg-white/[0.05] p-6">
            <div className="grid grid-cols-2 gap-3">
              {[
                ["Groom", "신랑"],
                ["Bride", "신부"],
                ["You are cordially invited", "초대합니다"],
              ].map(([a, b]) => (
          ...
          <div className="reveal">
            ...
            <h2 className="mt-5 text-3xl font-black text-white sm:text-5xl">Supports multiple languages</h2>
            <p className="mt-5 text-lg leading-8 text-zinc-300">
              Display your wedding invitation in multiple languages at once. This clone keeps English as the main UI, but preserves the visual feature.
            </p>
      ...
      <section className="bg-[#211815] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="reveal text-center">
            <h2 className="text-3xl font-black text-white sm:text-5xl">Everything You Need</h2>
            <p className="mt-4 text-zinc-300">One invitation with everything your wedding needs.</p>
          </div>
    ...
    <section id="templates" className="bg-[#18120f] py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="reveal flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h2 className="text-3xl font-black text-white sm:text-5xl">Handcrafted wedding invitation templates</h2>
            <p className="mt-4 max-w-2xl text-zinc-300">
              All 39 public ChungDoi templates are mirrored here as local assets, with the same tall preview style and hover motion.
            </p>
          </div>
        ...
        <div className="reveal mt-8 flex flex-col gap-4 rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 sm:flex-row sm:items-center sm:justify-between">
          <FilterPills label="Style" options={categories} value={category} onChange={setCategory} />
          <FilterPills label="Color" options={colors} value={color} onChange={setColor} />
        </div>
...
function TemplateCard({ template, onSelect }: { template: ChungDoiTemplate; onSelect: () => void }) {
  const demoHref = `/mau-thiep/${getVietnameseTemplateSlug(template.slug)}/demo`;
    ...
    <article className="reveal group overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#251b18] shadow-xl shadow-black/25 transition hover:-translate-y-2 hover:border-[#fb3570]/50 hover:shadow-2xl hover:shadow-[#fb3570]/10">
      <button onClick={onSelect} className="block w-full text-left">
        <div className="relative h-[460px] overflow-hidden bg-black">
          ...
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/45 to-transparent p-4">
            <div className="flex items-center gap-2">
              {template.isNew ? <span className="rounded-full bg-[#fb3570] px-2.5 py-1 text-xs font-black text-white">New</span> : null}
      ...
      <div className="p-5">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2">
          ...
          >
            Xem demo <ArrowRight className="size-4" />
          </a>
        </div>
      </div>
    </article>
          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <div className="rounded-2xl bg-white/[0.05] p-4">
                ...
                <p className="mt-1 font-black text-white">3 days free</p>
              </div>
            </div>
            <ul className="mt-6 space-y-3">
              {(template.highlights.length ? template.highlights : ["Mobile optimized", "RSVP ready", "Photo gallery included"]).map((item) => (
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                Xem demo thiệp <ArrowRight className="size-4" />
              </a>
              <a
                href="#templates"
                onClick={onClose}
...
function PricingFaq() {
  const faqs = [
    ["What is an online wedding invitation?", "A digital invitation page that replaces paper invites and includes maps, photos, guest wishes, gifts and RSVP."],
    ["How do I create one?", "Choose a template, add names/photos/date/venue, publish and share your unique link."],
    ["How much does it cost?", "Creating and customizing is free. Publishing includes a free 3-day trial, then a one-time payment keeps it live."],
    ["Can I edit after publishing?", "Yes. Edits update instantly on the same shared link."],
  ];
  ...
  return (
    <section id="pricing" className="bg-[#211815] py-20">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.75fr_1fr] lg:px-8">
        <div className="reveal">
          <h2 className="text-3xl font-black text-white sm:text-5xl">Simple pricing, no hidden fees</h2>
          <p className="mt-5 text-lg leading-8 text-zinc-300">
            Free to create. Try the live invitation for 3 days. Pay once only if you love it.
          </p>
          <div className="mt-8 rounded-[2rem] border border-[#fb3570]/35 bg-[#fb3570]/10 p-6">
            <p className="text-sm font-black uppercase tracking-[0.18em] text-[#ff8cad]">Popular</p>
            <p className="mt-4 text-5xl font-black text-white">$19.99</p>
            <p className="mt-2 text-zinc-300">One invitation, live forever after trial.</p>
            <ul className="mt-6 space-y-3 text-sm text-zinc-200">
              {["Unlimited views", "Guest manager and RSVP", "Maps, gallery, music, gift QR", "Editable after publishing"].map((item) => (
  ...
  return (
    <footer className="border-t border-white/10 bg-[#18120f] pb-24 pt-12 lg:pb-8">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.2fr_1fr_1fr_1fr] lg:px-8">
        <div>
          <Logo />
          <p className="mt-4 max-w-sm text-sm leading-6 text-zinc-400">Create beautiful online wedding invitations for free, in 10 minutes.</p>
        </div>
        {[
          ["Product", ["Wedding Templates", "Pricing", "How It Works"]],
          ["Tools", ["Save the Date Photo", "AI Invitation Messages", "Image Compressor", "Video Compressor"]],
          ["Resources", ["Help Center", "Privacy Policy", "Terms of Service", "Refund Policy"]],
        ].map(([heading, items]) => (
      ...
      <div className="mx-auto mt-10 flex max-w-7xl flex-col gap-3 px-4 text-sm text-zinc-500 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        <p>© 2026 ChungDoi - Online Wedding Invitations</p>
