...
import { BaroqueGoldInvitation } from "@/components/chungdoi-tpl-baroque-gold";
import { BohoFloralInvitation } from "@/components/chungdoi-tpl-boho-floral-brown";
import { BrocadeFlowerRedInvitation } from "@/components/chungdoi-tpl-brocade-flower-red";
import { ChateauGreenInvitation } from "@/components/chungdoi-tpl-chateau-green";
import { CherryBlossomInvitation } from "@/components/chungdoi-tpl-cherry-blossom-pink";
import { CrystalFloralInvitation } from "@/components/chungdoi-tpl-crystal-floral-blue";
import { DragonPhoenixV2Invitation } from "@/components/chungdoi-tpl-dragon-phoenix-v2-red";
import { DragonPhoenixV3Invitation } from "@/components/chungdoi-tpl-dragon-phoenix-v3-red";
import { ElegantLeafInvitation } from "@/components/chungdoi-tpl-elegant-leaf-green";
import { GlassGardenInvitation } from "@/components/chungdoi-tpl-glass-garden-green";
import { HoaTinhInvitation } from "@/components/chungdoi-tpl-hoa-tinh-red";
import { QasrGoldInvitation } from "@/components/chungdoi-tpl-qasr-gold";
import { QasrGreenInvitation } from "@/components/chungdoi-tpl-qasr-green";
...
function ChateauInvitation({ content }: { content: ChungDoiDemoContent }) {
  const { couple, families, venue, schedule, gallery, wishes, bank } = content;
  const ceremony = formatDate(couple.ceremonyDate || couple.date);
  const reception = formatDate(couple.date);
  const calendar = buildCalendar(couple.date);
      ...
      <div className="relative w-full max-w-[480px] overflow-hidden md:mx-auto md:max-w-[900px] md:border" style={{ color: CHATEAU_NAVY, borderColor: hexToRgba(CHATEAU_NAVY, 0.2) }}>
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-14 px-4 pb-14 md:px-10">
          ...
          <section className="relative w-full">
            ...
            <PhoenixWishForm M={CHATEAU_NAVY} />
            {wishes.length > 0 ? (
  ...
  return (
    ...
    <main id="top" className="relative min-h-screen bg-white" onClick={toggleAutoScroll}>
      ...
      {content.slug === "double-phoenix-red" || content.slug === "double-phoenix-green" ? (
        ...
        <ChateauInvitation content={content} />
