...
function Seal({ tokens, opening }: { tokens: Tokens; opening: boolean }) {
  return (
    <>
      {opening ? (
        <span
          className="pointer-events-none absolute left-1/2 top-[26px] z-20 size-14 rounded-full"
          style={{
      ...
      <div
        className="absolute left-1/2 top-[26px] z-30 flex size-14 items-center justify-center rounded-full"
        style={{
          transform: "translate(-50%, -50%)",
...
function BurstParticles({ tokens }: { tokens: Tokens }) {
  ...
  return (
    <div
      className="pointer-events-none absolute left-1/2 top-[26px] z-40"
