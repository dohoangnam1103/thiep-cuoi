...
export function ChateauInvitation({ content }: { content: ChungDoiDemoContent }) {
  ...
  return (
    <div className="flex w-full justify-center overflow-x-clip bg-white">
      <div className="relative w-full max-w-[480px] overflow-hidden mx-auto md:max-w-[900px] md:border" style={{ color: CHATEAU_NAVY, borderColor: hexToRgba(CHATEAU_NAVY, 0.2) }}>
        {/* faint side flower */}
        ...
        <div className="relative z-10 flex w-full flex-col items-center gap-14 px-4 pb-14 md:px-10">
          ...
          <section className="flex w-full flex-col items-center gap-8">
            ...
            <div className="flex w-full flex-col items-center gap-2 text-center">
              {/* Tên không khai font, thừa hưởng body của thẻ như tên ba mẹ */}
          ...
          {gallery.length > 0 ? (
            <section className="flex w-full flex-col items-center gap-6">
              ...
              <AlbumGallery photos={gallery} layout={content.albumLayout ?? "grid"} accent={CHATEAU_NAVY} />
            </section>
          ) : null}
          ...
          <section className="relative flex w-full flex-col items-center gap-3">
            ...
            {reception ? <div className="text-[10px] uppercase tracking-[0.15em] md:text-base md:tracking-[0.25em]" style={{ color: CHATEAU_NAVY_MUTED }}>{reception.lunar}</div> : null}
          ...
          {banks.length > 0 ? (
            <section className="w-full text-center">
              <GiftEnvelope templateSlug={content.slug} banks={banks} accent={CHATEAU_NAVY} dark={CHATEAU_NAVY} cardBg="#f7f2e7" heading="Phong Bao Mừng Cưới" labelColor={CHATEAU_NAVY_MUTED} />
            </section>
          ) : null}
        </div>
