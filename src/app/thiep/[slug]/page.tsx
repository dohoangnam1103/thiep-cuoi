...
export default async function PublicInvitationPage({
  ...
  const mediaLabels = {
    ...
    zoomIn: invitationTranslations("media.zoomIn"),
    zoomOut: invitationTranslations("media.zoomOut"),
    resetZoom: invitationTranslations("media.resetZoom"),
    previous: invitationTranslations("media.previous"),
    next: invitationTranslations("media.next"),
    imageAlt: invitationTranslations("media.imageAlt"),
    videoAlt: invitationTranslations("media.videoAlt"),
